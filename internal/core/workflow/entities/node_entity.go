...
//	NodeTypeQuestionClassifier NodeType = "question_classifier" // 新增意图识别分类节点
//	NodeTypeIteration          NodeType = "iteration"           // 新增迭代节点
...
//		Inputs   map[string]any `json:"inputs"`    // 节点的输入数据
//		Outputs  map[string]any `json:"outputs"`   // 节点的输出数据
