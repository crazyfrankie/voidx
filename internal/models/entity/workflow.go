...
type Workflow struct {
	...
	Graph         map[string]any        `gorm:"type:jsonb;not null;default:'{}'::jsonb" json:"graph"`
	DraftGraph    map[string]any        `gorm:"type:jsonb;not null;default:'{}'::jsonb" json:"draft_graph"`
...
type WorkflowResult struct {
	...
	Graph      map[string]any              `gorm:"type:jsonb;not null;default:'{}'::jsonb" json:"graph"`
	State      map[string]any              `gorm:"type:jsonb;not null;default:'{}'::jsonb" json:"state"`
